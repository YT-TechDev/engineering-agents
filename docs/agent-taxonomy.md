  ...
  web/
    ...
    design/
      ...
      advanced/
        ...
        service-design-agent.md
        research-operations-agent.md
        design-system-release-management-agent.md
        design-metrics-agent.md
  infrastructure/
...
- future design subdomains such as design privacy review, localization design, design ops governance, content operations, design-to-support workflows, and design research quality review
- `product`
