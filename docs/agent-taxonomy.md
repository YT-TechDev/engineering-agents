...
- future frontend subdomains such as advanced browser storage, PWA review, frontend analytics/product metrics, frontend platform governance, design system release management, advanced forms, and other frontend specialty agents
- `product`
