...
Engineering Agents provides role-based AI agent definitions and workflow templates for engineering-related documentation work.

## Purpose

The project helps teams describe what each agent should do, what it should avoid, how it should validate work, and what outputs are expected. The repository is intentionally documentation-only so the guidance remains portable across tools and projects.
