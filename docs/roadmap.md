...
- Web frontend agent guidance, including the initial React, Next.js, and component library expansion plus the started frontend advanced/library/testing expansion for library selection, state/data fetching, forms/validation, styling/UI libraries, motion/animation, Three.js/R3F, Next.js boundaries, interactive web, performance, security boundaries, frontend testing, advanced accessibility, visualization/charts, editor experiences, WebGPU/WebXR, performance design, and the started frontend operations/systems expansion for observability, browser API safety, design engineering, animation systems, and release workflow
...
- PWA review, frontend analytics/product metrics, advanced forms, frontend platform governance, design system release management, and other frontend specialty agents beyond the started advanced/library/testing/operations expansion
- Native app agents
- Desktop app agents
