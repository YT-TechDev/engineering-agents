...
- Documentation-focused guidance, Codex documentation workflow guidance, repository onboarding and usage docs, reusable role/task/review templates, public OSS hygiene guidance, language and locale guidance, docs-only checklists, and reusable agent usage templates and review checklists for practical PR and review workflows.
