...
- Web frontend agent guidance, including the initial React, Next.js, and component library expansion plus the started frontend advanced/library expansion for library selection, state/data fetching, forms/validation, styling/UI libraries, motion/animation, Three.js/R3F, Next.js boundaries, interactive web, performance, and security boundaries
...
- Advanced accessibility, frontend testing, WebGPU/WebXR, and other frontend specialty agents beyond the started advanced/library expansion
- Native app agents
- Desktop app agents
