...
- Initial web backend agent guidance under `agents/web/backend/`, covering web backend planning, Node.js and TypeScript API work, API contracts, database/ORM review, BaaS integration, and auth/API security review
