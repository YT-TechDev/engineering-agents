...
- Coordinate with `agents/mobile/mobile-release-store-review-agent.md` when release scope crosses mobile distribution, store-review, signing, rollout, or app privacy disclosure boundaries.
- Coordinate with feature flag/rollout boundary review, experiment analysis integrity review, metric integrity review, and BI/dashboard hygiene review when release claims depend on analytics evidence, dashboards, reports, or public data summaries.
