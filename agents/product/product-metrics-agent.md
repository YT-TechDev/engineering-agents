...
- Coordinate with frontend analytics/product metrics, metric integrity review, hypothesis/success criteria review, experiment analysis integrity review, analytics instrumentation review, data quality/lineage review, design metrics, UX research/product discovery, service design, privacy/data boundary review, mobile release/store review, compliance review, release scope review, and PRD review agents when metrics involve analytics, telemetry, crashes, app store signals, or mobile privacy disclosures.
