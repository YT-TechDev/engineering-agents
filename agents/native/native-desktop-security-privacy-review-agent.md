...
- Coordinate with security boundary review, privacy/data boundary review, secrets/credential hygiene review, dependency/supply-chain review, threat modeling/abuse case review, analytics instrumentation review, BI/dashboard hygiene review, desktop architecture review, Electron or Tauri boundary review, OS integration review, local runtime process review, release scope review, release quality review, and public OSS hygiene review agents when local telemetry, crash reports, or desktop analytics are in scope.
