...
- Coordinate with PWA/offline, frontend analytics/product metrics, frontend release workflow, and frontend observability agents when release gates or post-release monitoring are in scope.
