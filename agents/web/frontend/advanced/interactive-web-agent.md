...
- Coordinate with UX, visual design, interaction design, accessibility, component library, advanced accessibility, WebGPU/WebXR, visualization/charts, editor experience, frontend testing, and performance design agents, including when simpler UI is better.
