...
- Coordinate with Codex prompt writer, Codex docs reviewer, prompt safety reviewer, template governance review, repository governance review, scope-control reviewer, public OSS hygiene reviewer, PR body review agent, security boundary review, privacy/data boundary review, feedback-to-decision review when AI-generated summaries influence product decisions, and merge-readiness review coordinator.
...
- Coordinate with `agents/workflow/ai-workflow-routing-review-agent.md` and `agents/ai/agent-tool-permission-review-agent.md` when AI-assisted workflows involve tool authority, owner approval, or routing risk.
