...
- Coordinate with `agents/mobile/mobile-release-store-review-agent.md` and `agents/security/privacy-data-boundary-review-agent.md` when mobile store privacy disclosures, Data Safety awareness, permissions, analytics, crash reports, signing/distribution evidence, or mobile release claims intersect compliance-oriented review, while avoiding legal or compliance guarantees.
