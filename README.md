...
agents/       Role-based agent definitions for web, product, infrastructure, review, and docs work
...
Current confirmed scope includes web frontend, web frontend libraries/testing/advanced agents, web backend, Product / PM planning and review agents, infrastructure, review, web design, advanced web design agents, and Codex documentation/review workflow guidance. Future ideas such as native/desktop agents and additional design/backend/infrastructure refinements should remain roadmap candidates until actual agent content is added.
